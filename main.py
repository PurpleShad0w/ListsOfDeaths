...
kill_count_total([attack_on_titan,jojos_bizarre_adventure,demon_slayer],
    ['attack_on_titan','jojos_bizarre_adventure','demon_slayer']).to_csv('counts/killers.csv')
...
cause_count_total([attack_on_titan,jojos_bizarre_adventure,demon_slayer]).to_csv('counts/causes.csv')

# Create total death count
death_count([attack_on_titan,jojos_bizarre_adventure,demon_slayer],
    ['attack_on_titan','jojos_bizarre_adventure','demon_slayer']).to_csv('counts/death_count.csv')
