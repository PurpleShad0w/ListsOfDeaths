...
gantz = pd.read_csv('death_lists/gantz.csv')
...
murder_graph(gantz).write_html('graphs/gantz_who_killed_who.html')
...
kill_count(gantz).to_csv('counts/gantz_top_killers.csv')
...
kill_count_total([attack_on_titan,deadman_wonderland,demon_slayer,gantz,jojos_bizarre_adventure,just_cause,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','deadman_wonderland','demon_slayer','gantz','jojos_bizarre_adventure','just_cause','my_hero_academia','the_world_ends_with_you']).to_csv('counts/killers.csv')
...
cause_count(gantz).to_csv('counts/gantz_top_causes.csv')
...
cause_count_total([attack_on_titan,deadman_wonderland,demon_slayer,gantz,jojos_bizarre_adventure,just_cause,my_hero_academia,the_world_ends_with_you]).to_csv('counts/causes.csv')

# Create total death count
death_count([attack_on_titan,deadman_wonderland,demon_slayer,gantz,jojos_bizarre_adventure,just_cause,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','deadman_wonderland','demon_slayer','gantz','jojos_bizarre_adventure','just_cause','my_hero_academia','the_world_ends_with_you']).to_csv('counts/death_count.csv')

# Combine death lists
death_list_combiner([attack_on_titan,deadman_wonderland,demon_slayer,gantz,jojos_bizarre_adventure,just_cause,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','deadman_wonderland','demon_slayer','gantz','jojos_bizarre_adventure','just_cause','my_hero_academia','the_world_ends_with_you']).to_csv('death_lists/death_list.csv')