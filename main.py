...
kill_count_total([attack_on_titan,demon_slayer,jojos_bizarre_adventure,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','demon_slayer','jojos_bizarre_adventure','my_hero_academia','the_world_ends_with_you']).to_csv('counts/killers.csv')
...
cause_count_total([attack_on_titan,demon_slayer,jojos_bizarre_adventure,my_hero_academia,the_world_ends_with_you]).to_csv('counts/causes.csv')

# Create total death count
death_count([attack_on_titan,demon_slayer,jojos_bizarre_adventure,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','demon_slayer','jojos_bizarre_adventure','my_hero_academia','the_world_ends_with_you']).to_csv('counts/death_count.csv')

# Combine death lists
death_list_combiner([attack_on_titan,demon_slayer,jojos_bizarre_adventure,my_hero_academia,the_world_ends_with_you],
    ['attack_on_titan','demon_slayer','jojos_bizarre_adventure','my_hero_academia','the_world_ends_with_you']).to_csv('death_lists/death_list.csv')